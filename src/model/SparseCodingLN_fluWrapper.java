 ...
 *
 java7lib -Xms10g model/SparseCodingLN_wrapper 10 1 1 1 1000 1000 1 500 98765 g1p1 g1p1 g1p1 g1p1 g1p1 0.1
 java -cp .:../library/\* -Xms4g model/SparseCodingLN_wrapper 10 1 1 1 1000 1000 1 500 98765 g1p1toy g1p1 g1p1 g1p1 g1p1 0.1
 */
public class SparseCodingLN_fluWrapper {
    public static void main(String[] args) throws IOException {
        ...
        String motif2File = "../data/FluMotifWithNeighbour_Mutual.txt";
        String deltaOutFile = "../data/FluDelta_Mutual.txt";
        ...
        while ((line = mbr2.readLine()) != null) {
            ...
            for (int i = 0; i < 120; i++) {
                motifTemp[i] = Double.parseDouble(field[i + 3]);
            }
